...
const SignedInLinks = ({onLogout, state}) => {
    ...
    return (
        <ul id="nav-mobile" className="right hide-on-med-and-down">
            ...
            <li><NavLink to='/cCenter'><i className="fas fa-bell notif"></i></NavLink></li>
...
export const SignedInLinksSidebar = ({onClickLink, onLogout, state}) => {
    ...
    return (
        <div>
            ...
            <li><NavLink to='/cCenter' className="cyan-text" onClick={onClickLink}><i className="fas fa-bell"></i></NavLink></li>
